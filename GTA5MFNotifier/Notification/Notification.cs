...
namespace GTA5MFNotifier
{
    public partial class Notification : Form
    {
        ...
        public Notification(string link, string title, string body, int duration, FormAnimator.AnimationMethod animation, FormAnimator.AnimationDirection direction)
        {
            InitializeComponent();
